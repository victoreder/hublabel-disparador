...
export function buildSystemPrompt(job, agente) {
  ...
  const partes = [
    ...
    '- Formato markdown: imagem [nome (image)](https://...), vídeo [nome (video)](https://...), áudio [nome (audio)](https://...).',
    '- Nunca altere a URL ou a extensão; separe mídias e textos com 2 enters.',
    'Exemplo imagem: [Perfume Árabe (image)](https://cdn.exemplo.com/perfume.jpg)',
    'Exemplo áudio: [APRESENTACAO.mp3 (audio)](https://s3.disparamator.com.br/n8n/APRESENTACAO.mp3)',
    '',
    '## INSTRUÇÕES:',
    agente?.instrucoes || '',
    '-----',
