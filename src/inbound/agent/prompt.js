...
export function buildSystemPrompt(job, agente, { handoff = false } = {}) {
  ...
  const partes = [
    ...
    '- Prefira uma única mensagem curta e conversacional. Se existirem opções diferentes ou informações conflitantes, explique isso naturalmente e pergunte qual opção interessa.',
    '',
    '## INSTRUÇÕES:',
    agente?.instrucoes || '',
    '-----',
