...
export function buildSystemPrompt(job, agente) {
  ...
  const partes = [
    ...
    '- Atenção: transferir-atendente / transferir-setor com atendente / abrir atendimento PAUSAM o agente. Só emita essas se o usuário realmente pedir transferência humana.',
    '',
    '## CAMPO PERSONALIZADO',
